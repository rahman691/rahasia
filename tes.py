...
class Bot(object):
    def __init__(self, key):
        ...
        self.chance1 = float(input('Chance1:'))
        self.chance2 = float(input('Chance2:'))
        #self.PayIn_origin1 = float(input('Base bet:'))
        #self.PayIn1 = float(input('Bet size:'))
        highbet = 1000000-int((1000000*float(self.chance))/100)
        lowbet = 999999-(1000000-int((1000000*float(self.chance))/100))
        self.bet = [(0, lowbet), (highbet, 999999)]
        highbet1 = 1000000-int((1000000*float(self.chance1))/100)
        lowbet1 = 999999-(1000000-int((1000000*float(self.chance1))/100))
        self.bet1 = [(0, lowbet1), (highbet1, 999999)]
        highbet2 = 1000000-int((1000000*float(self.chance2))/100)
        lowbet2 = 999999-(1000000-int((1000000*float(self.chance2))/100))
        self.bet2 = [(0, lowbet2), (highbet2, 999999)]
        self.multi = None
        self.multi1 = None
